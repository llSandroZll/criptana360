...
(function () {
  window.spotsData = {
    ...
    spot_albaicin: {
      id: 'spot_albaicin',
      category: 'monumento',
      img: 'images/real_barrio_albaicin.jpg',
      phone: '+34926563931',
    ...
    spot_fuente_cano: {
      id: 'spot_fuente_cano',
      category: 'monumento',
      img: 'images/real_fuente_cano.png',
      phone: '+34926563931',
    ...
    spot_sara_montiel: {
      ...
      category: 'monumento',
      img: 'images/real_sara_montiel.png',
      phone: '+34926563931',
    ...
    spot_ci_molinos: {
      id: 'spot_ci_molinos',
      category: 'monumento',
      img: 'images/real_ci_molinos.png',
      phone: '+34926563931',
    ...
    spot_sala_carros: {
      id: 'spot_sala_carros',
      category: 'monumento',
      img: 'images/real_sala_carros.png',
      phone: '+34926563931',
    ...
    spot_posito: {
      id: 'spot_posito',
      category: 'monumento',
      img: 'images/real_posito_real.jpg',
      phone: '+34926563931',
    ...
    spot_patrimonio_religioso: {
      ...
      category: 'monumento',
      img: 'images/real_convento_carmelitas.jpg',
      phone: '+34926563931',
    ...
    spot_iglesia_parroquial: {
      ...
      category: 'monumento',
      img: 'images/real_iglesia_asuncion.jpg',
      phone: '+34926563931',
    ...
    spot_pozo_nieve: {
      id: 'spot_pozo_nieve',
      category: 'monumento',
      img: 'images/real_pozo_nieve.jpg',
      phone: '+34926563931',
    ...
    spot_ermita_criptana: {
      ...
      category: 'monumento',
      img: 'images/real_ermita_virgen_criptana.jpg',
      phone: '+34926563931',
    ...
    spot_ermita_villajos: {
      ...
      category: 'monumento',
      img: 'images/real_cristo_villajos.jpg',
      phone: '+34926563931',
    ...
    spot_torrecilla: {
      id: 'spot_torrecilla',
      category: 'restaurante',
      img: 'images/real_plaza_mayor.png',
      phone: '+34926563931',
    ...
    spot11: {
      ...
      bookingUrl: 'https://www.jdoqocy.com/click-101761861-11891543?url=https%3A%2F%2Fwww.booking.com%2Fsearchresults.html%3Fss%3Dcampo%2Bde%2Bcriptana',
    ...
    spot_piscina_municipal: {
      ...
      category: 'monumento',
      img: 'images/piscina_municipal.jpg',
      phone: '+34926561242',
  ...
  window.translations = {
    es: {
      ...
      'widget.sunset': 'Calculando amanecer y atardecer...',
      'widget.eclipse': 'Eclipse Solar & Perseidas · 12 Ago',
      'widget.eclipse.link': 'Guía ℹ️',
      'astro.banner.badge': 'EVENTO ASTRONÓMICO HISTÓRICO · 12 AGOSTO 2026',
      'astro.banner.title': 'Eclipse Solar Total & Noche de Perseidas en los Molinos',
      'astro.banner.desc': 'Campo de Criptana se encuentra en la franja privilegiada para presenciar el Eclipse Solar Total al atardecer sobre los molinos gigantes, seguido por la noche cumbre de las Perseidas.',
      'astro.banner.countdownlabel': 'Cuenta atrás al Eclipse Total:',
      'astro.banner.btn': 'Ver Guía Astronómica Completa &rarr;',
      'astro.banner.explore': 'Descubrir el Pueblo &darr;',
      'luze.banner.tag': 'AGENCIA DIGITAL & MARKETING',
      'luze.banner.title': '¿Tienes un Negocio en La Mancha? Destaca con LUZE Media',
      'luze.banner.desc': 'Aumenta tu facturación, atrae más clientes locales y turistas con diseño web artesanal de alto impacto, SEO local y campañas de conversión.',
      'luze.banner.btn': 'Impulsa tu Negocio con LUZE Media &rarr;',
      'luze.banner.b2b': 'Anúnciate en Criptana 360',
      'astro.modal.title': 'Guía del Eclipse Solar Total 2026 y Perseidas',
      'astro.modal.subtitle': 'Todo lo que necesitas saber para vivir una experiencia astronómica inolvidable entre los molinos de Don Quijote.',
      'astro.tab.eclipse': '☀️ Eclipse Solar Total (12 Ago)',
      'astro.tab.perseids': '🌠 Perseidas / Lágrimas (Noche 12-13 Ago)',
      'astro.tab.mizona': '📍 Comprobar Mi Ubicación',
      'astro.mizona.title': '¿Cómo se verá el Eclipse 2026 en tu Zona?',
      'astro.mizona.subtitle': 'Descubre el porcentaje de totalidad, la hora exacta y si tu ubicación estará en la franja privilegiada de La Mancha.',
      'astro.mizona.btn.gps': '📍 Detectar Mi Ubicación',
      'astro.mizona.select.placeholder': '-- Selecciona o busca tu municipio --',
      'astro.modal.booking': '🏨 Buscar Alojamientos para el Eclipse &rarr;',
      'astro.modal.close': 'Cerrar Guía',
      ...
      'btn.tour': '⚔️ Gymkana Interactiva &rarr;',
      'drawer.btn.tour': '⚔️ Empezar Gymkana Interactiva',
      ...
      'bento.desc': 'Descubre las mejores rutas por los molinos históricos y reserva tu estancia en casas cueva con encanto.',
      'bento.tour.title': 'Ruta por los Molinos',
      'bento.tour.subtitle': 'Guía de los Gigantes',
    ...
    en: {
      ...
      'luze.banner.desc': 'Boost your revenue and attract local customers & travelers with bespoke web design, local SEO, and high-converting marketing campaigns.',
      'luze.banner.btn': 'Grow Your Business with LUZE Media &rarr;',
      'luze.banner.b2b': 'Advertise on Criptana 360',
      'astro.modal.title': 'Total Solar Eclipse 2026 & Perseids Guide',
      'astro.modal.subtitle': 'Everything you need to know to experience a historic astronomical event among Don Quixote\'s windmills.',
      'astro.tab.eclipse': '☀️ Total Solar Eclipse (Aug 12)',
      'astro.tab.perseids': '🌠 Perseids Meteor Shower (Aug 12-13)',
      'astro.modal.booking': '🏨 Search Hotels for the Eclipse &rarr;',
      'astro.modal.close': 'Close Guide',
      ...
      'btn.tour': '⚔️ Interactive Gymkana &rarr;',
      'drawer.btn.tour': '⚔️ Start Interactive Gymkana',
      ...
      'bento.desc': 'Discover the best historic windmill routes and book charming cave accommodations.',
      'bento.tour.title': 'Windmills Route',
      'bento.tour.subtitle': 'Giants Guide',
